...
### Project Code: [Singly Linked Lists: Task 0 ]([https://duckduckgo.com](https://github.com/manningstinson/holbertonschool-low_level_programming/blob/main/singly_linked_lists/0-print_list.c)).  
